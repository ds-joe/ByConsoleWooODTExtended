...
*/
   ...
   //alert("delivery_break_time_start" + interval_time_set2_last_value_split[0] + '--' + interval_time_set2_last_value_add_val_minutes_more);



  // alert("delivery_break_time_end" + interval_time_set2_last_value_add_val_hours_more_break_time_end + '--' + interval_time_set2_last_value_add_val_minutes_more);
	...
	{		
		...
		//console.log(i_len + '===' + interval_time_set_length);	
...

		 {
				...
				var delivery_time_obj_val = {label: timeString + ' - ' + timeStringg, value: timeString + ' - ' + timeStringg};
	...
	{		
		...
		//console.log(i_len2 + '===' + interval_time_set_length2);	
...

		 {
				...
				var delivery_time_obj_val2 = {label: timeString2 + ' - ' + timeStringg2, value: timeString2 + ' - ' + timeStringg2};

...
$byconsolewooodt_deliverydays_array=explode(' ', $get_byc_wooodt_data['byconsolewooodt_delivery_days']);
//echo 'AYAN';
//print_r($byconsolewooodt_deliverydays_array);
//$byconsolewooodt_deliverydays_array=[1,2,4,6,7];
